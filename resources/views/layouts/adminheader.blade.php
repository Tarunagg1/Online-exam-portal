    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <span class="brand-text font-weight-light">Online Exam System</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/examcategory')}}" class="nav-link @if(1) active @endif">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/manage_student')}}" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Add Student
                                </p>
